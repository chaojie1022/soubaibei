...
For merged cells, when you do refresh, next pageReq or switch columns to show, the merge cells will be unmerged. We can listen the events(on load success, on column switch, on pageReq change and on search) to solve this problem, code example:
